...
type Overtime struct {
	...
	Status      types.Status `json:"status" gorm:"column:status;not null"`
	Approval    string       `json:"approval,omitempty" gorm:"column:approval;not null"`
